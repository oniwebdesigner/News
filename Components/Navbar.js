                        ...
                        <li className='relative'>
                            ...
                            {isDropdownOpen && (
                                <ul className='absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md text-black'>
                                    <li className='px-4 py-2 hover:bg-gray-200' onClick={handleDropdownClick}><Link href="/sports/Football">Football</Link></li>
                                    <li className='px-4 py-2 hover:bg-gray-200' onClick={handleDropdownClick}><Link href="/">Basketball</Link></li>
                                    <li className='px-4 py-2 hover:bg-gray-200' onClick={handleDropdownClick}><Link href="/sports/tennis">Tennis</Link></li>
                                </ul>
                            )}
                        </li>
